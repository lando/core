...
class FinchDaemonManager {
  constructor(opts = {}) {
    ...
    this.containerdSocket = opts.containerdSocket || path.join(userConfRoot, 'run', 'containerd.sock');
    this.socketPath = opts.socketPath || path.join(userConfRoot, 'run', 'finch.sock');
