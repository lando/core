...
module.exports = class App {
  constructor(name, config, lando = {}) {
    ...
    // Use the engine from lando (created by BackendManager) when available,
    // falling back to setup-engine for legacy compatibility
    this.engine = lando.engine || require('../utils/setup-engine')(
      lando.config,
      lando.cache,
      lando.events,
      this.log,
