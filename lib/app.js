...
module.exports = class App {
  constructor(name, config, lando = {}) {
    ...
    // lets start to add pseudo v4 props here
    this.v4 = {};

    // @TODO: how and more importantly where/when do we clean this up?
    this.v4._dir = path.join(this._config.userConfRoot, 'v4', this.id);
    this.v4.buildContexts = [];
  };
   ...
   */
  addBuildContext(data, front = false) {
    if (front) this.v4.buildContexts.unshift(data);
    else this.v4.buildContexts.push(data);
  }
