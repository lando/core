...
module.exports = class App {
  ...
  init() {
    ...
    console.log(_.get(this, 'config.compose', []))
    const composeFiles = require('../utils/load-compose-files')(_.get(this, 'config.compose', []), this.root, this.version); // eslint-disable-line
