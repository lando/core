...
class BackendManager {
  ...
  _createContainerdEngine(id) {
    ...
    const compose = (cmd, datum) => {
      // Ensure CNI network configs exist for ALL compose-created networks.
      ...
      // This covers the _default network PLUS any explicitly defined networks
      // (e.g. custom bridge networks, proxy edge networks, etc.).
      if (cmd === 'start') {
