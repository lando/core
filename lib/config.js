...
const defaultConfig = options => {
  // mix compose version into the options
  options.composeVersion = options.composeVersion || '2.21.0';
  // return
  return {
    composeBin: env.getComposeExecutable(options),
    composeCompatibility: true,
    composeVersion: options.composeVersion,
    disablePlugins: [],
 ...
 */
exports.loadEnvPluginConfig = prefix => _(process.env)
