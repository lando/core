...
module.exports = async (app, lando) => {
  ...
  // we need this workaround — but skip for containerd engine which manages its own compose
  if (lando._bootstrapLevel >= 3 && !app.engine.composeInstalled && (lando.config.engine !== 'containerd')) {
