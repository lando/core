...
lando info --service web --path hostnames | grep hostnames | grep web.landoinfo.internal
...
lando info --service web2 --path hostnames | grep hostnames | grep web2.landoinfo.internal
...
lando info --service web3 --path hostnames | grep hostnames | grep web3.landoinfo.internal
...
lando info --service web4 --path hostnames | grep hostnames | grep web4.landoinfo.internal
